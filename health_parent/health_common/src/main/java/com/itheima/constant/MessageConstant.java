...
public class MessageConstant {
    ...
    public static final String UPDATE_USERPASSWORD_FAIL = "修改用户密码失败";
    public static final String UPDATE_USERPASSWORD_SUCCESS = "修改用户密码成功";
    public static final String USERNAME_NOTFOUND = "用户名填写错误";
}